...
export default function ProductDetail(props) {
  ...
  useEffect(() => {
    ...
    // setSelectedItemsToAdd([{id: selectedVarObj?.id, uniqueId: selectedVarObj?.uniqueId, title: selectedVarObj?.title, imageSrc: productData?.imageSrc, prdHandleName : productData?.prdHandleName}])
  }, [productData]);
    ...
    <>
      <div className="md:as-grid as-grid-cols-12 as-gap-4 as-py-2 as-mb-3">
        <div className="as-col-span-5">
          <img src={productData?.featured_image} alt="" className="as-w-full as-max-w-xs" />
        </div>
