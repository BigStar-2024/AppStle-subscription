...
const PrdRadioPopup = ({
  ...
  const handleCheck = (id, imageSrc, title) => {
    setSelectedItems({id: id, displayName: title, imageSrc: imageSrc})
               ...
               return  <ListGroupItem className="multiselect-list-item" key={id}>
                {
                    ...
                    <Label className="pt-2">
                        <Input type="radio" name="variantselect" onChange={() => handleCheck(id, imageSrc, title)}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(PrdRadioPopup);
