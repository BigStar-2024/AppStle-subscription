...
import { getSkipOrderEntityForReport } from 'app/entities/subscription-billing-attempt/subscription-billing-attempt.reducer';
...
const SkipOrderReport = ({ getSkipOrderEntityForReport, loading, shopInfo, skipOrderEntities, ...props }) => {
  ...
  const handleGridData = () => {
    getSkipOrderEntityForReport(activePage - 1, itemsPerPage, filterVal, 'SKIPPED');
  };
  useEffect(() => {
    handleGridData();
...
const mapStateToProps = state => ({
  skipOrderEntities: state.subscriptionBillingAttempt.skipBillingAttemptDetail,
  shopInfo: state.shopInfo.entity
});

const mapDispatchToProps = {
    getSkipOrderEntityForReport
};

export default connect(mapStateToProps, mapDispatchToProps)(SkipOrderReport);
