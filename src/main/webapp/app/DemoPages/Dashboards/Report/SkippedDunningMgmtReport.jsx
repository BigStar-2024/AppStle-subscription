...
import { getSkippedDunningMgmtOrderEntityForReport, updateAttemptBillingEntity } from 'app/entities/subscription-billing-attempt/subscription-billing-attempt.reducer';
...
const SkippedDunningMgmtReport = ({ getSkippedDunningMgmtOrderEntityForReport, loading, shopInfo, skipOrderEntities, updateAttemptBillingEntity, ...props }) => {
  ...
  const handleGridData = () => {
    getSkippedDunningMgmtOrderEntityForReport(activePage - 1, itemsPerPage, filterVal, 'SKIPPED_DUNNING_MGMT');
  };
  useEffect(() => {
    handleGridData();
...
const mapStateToProps = state => ({
  skipOrderEntities: state.subscriptionBillingAttempt.skipBillingAttemptDunningMgmt,
  shopInfo: state.shopInfo.entity,
  updatingBillingAttempt: state.subscriptionBillingAttempt.updatingBillingAttempt
});

const mapDispatchToProps = {
    getSkippedDunningMgmtOrderEntityForReport, 
    updateAttemptBillingEntity
};

export default connect(mapStateToProps, mapDispatchToProps)(SkippedDunningMgmtReport);
