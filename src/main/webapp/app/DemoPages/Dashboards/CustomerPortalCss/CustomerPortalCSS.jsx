...
const CustomerPortalCSS = ({subCustomCSSEntity, getEntities, getEntity, updateEntity, createEntity, ...props}) => {
...
//  }
  ...
  return (
    <Fragment>
      ...
      >
        <PageTitle
          heading="Customer Portal CSS"
          subheading="Advanced tool to align the look and feel of our customer portal with your store."
                      ...
                      <Col xs={12} sm={12} md={12} lg={12} className="md-6">
                        <FormGroup>
                          <Field
                            ...
                            id="customerPoratlCSS"
                            className="form-control"
                            type="textarea"
                            name="customerPoratlCSS"
                          />
                        </FormGroup>
                      </Col>
                    </Row>
