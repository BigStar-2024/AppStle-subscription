...
export class ShopifyFlow extends Component {
  constructor(props) {
    super(props);
    this.state = {
      apiKey: null,
          ...
          return (
            <form onSubmit={handleSubmit}>
              <Modal isOpen={this.props.isOpen} size="lg">
                <ModalHeader>Shopify Flow</ModalHeader>
                <FeatureAccessCheck hasAnyAuthorities={'accessShopifyFlowIntegration'} upgradeButtonText="Upgrade your plan">
                  <ModalBody>
                    <FormGroup>
...
export default connect(mapStateToProps, mapDispatchToProps)(ShopifyFlow);
