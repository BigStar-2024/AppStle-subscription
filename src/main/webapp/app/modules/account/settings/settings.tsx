          ...
          <AvForm id="settings-form" onValidSubmit={handleValidSubmit}>
            ...
            <AvField
              ...
              validate={{
                ...
                maxLength: { value: 1000, errorMessage: 'Your first name cannot be longer than 1000 characters' }
              }}
            ...
            <AvField
              ...
              //   maxLength: { value: 1000, errorMessage: 'Your last name cannot be longer than 1000 characters' }
              // }}
